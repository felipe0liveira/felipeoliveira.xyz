...
function GlitchTitle() {
  ...
  useEffect(() => {
    ...
    async function burst() {
      ...
      await animate(
        scope.current,
        { x: [-4, 3, -6, 2, 0], skewX: ['-2deg', '3deg', '-1deg', '0deg'] },
  ...
  return (
    <div
      ref={scope}
      className='relative text-4xl md:text-6xl font-bold mb-8 font-mono select-none'
      aria-label='SYSTEM_BOOT'
    >
      {/* White base */}
      ...
      {isBooting && (
        ...
        >
          ...
          <motion.div
            ...
            animate={{ opacity: [0.04, 0.1, 0.02, 0.08, 0.01, 0.06] }}
              ...
              {BOOT_LINES.map((line, i) => (
                ...
                >
                  ...
                  <motion.span
                    ...
                    transition={
                      i === BOOT_LINES.length - 1
                        ? { duration: 0.8, repeat: Infinity, delay: 1.5 }
                        : {}
                    }
                  >
                    {line.text}
