      ...
      <div className='relative z-10 max-w-7xl mx-auto px-6'>
        ...
        <div className='mb-16'>
          ...
          <p className='text-gray-400 max-w-3xl leading-relaxed'>
            Open-source contributions and public projects showcasing continuous
            learning and community involvement in the software development
            ecosystem.
          </p>
        </div>
          ...
          >
            ...
            <div className='space-y-6'>
              ...
              <div className='grid md:grid-cols-2 gap-8'>
                <div className='space-y-4'>
                  <div className='flex items-start gap-4'>
                    ...
                    <div className='flex-1'>
                      ...
                      <div className='text-lemon-500 text-xl font-bold mb-2'>
                        {profile.name}
                      </div>
                      {profile.company && (
                ...
                <div className='grid grid-cols-2 gap-4'>
                  <div className='border border-lemon-500/30 p-4 bg-lemon-950/10'>
                    ...
                    <div className='text-lemon-500 text-3xl font-bold'>
              ...
              <div className='border-t border-gray-800 pt-6 space-y-2'>
                ...
                <div className='text-gray-500'>
                  <span className='text-lemon-500'>&gt;</span> Profile
                  verification:
