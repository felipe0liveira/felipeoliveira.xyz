      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="mb-16">
          <div className="flex items-center gap-4 mb-6">
            <span className="text-pink-500 font-mono text-sm">03. PORTFOLIO</span>
          ...
          <p className="text-gray-400 max-w-3xl leading-relaxed">
            A showcase of successful projects delivered for clients across different industries, 
            demonstrating expertise in creating scalable, modern, and user-friendly web applications.
          </p>
        </div>
