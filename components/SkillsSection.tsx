      ...
      <div className='relative z-10 max-w-7xl mx-auto px-6'>
        ...
        <div className='mb-16'>
          <div className='flex items-center gap-4 mb-6'>
            <span className='text-lemon-500 font-mono text-sm'>
              02. EXPERTISE
            </span>
          ...
          <p className='text-gray-400 max-w-3xl leading-relaxed'>
            Throughout my journey as a developer, I've had the opportunity to
            work across different areas, from frontend to backend, including
            fullstack integrations and software quality practices. This
            diversity has allowed me to build a broad perspective, connecting
            the creation of modern and intuitive interfaces with robust server
            architectures, while also applying testing methodologies and
                ...
                >
                  ...
                  <div className='mt-4 flex items-center gap-2'>
                    ...
                    <span className='text-xs text-gray-500 font-mono'>
                      SKILL_{String(skill.id).padStart(2, '0')}
                    </span>
                  </div>
                </div>
              ))}
