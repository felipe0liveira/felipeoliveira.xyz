export const Homepage = {
	aboutWindows98Theme: {
		title: {
			'pt-BR': 'Por que meu site tem esse visual?',
			'en-US': 'Why does my website have this visual?',
		},
		description: {
			'pt-BR':
				'Meu site tem um visual retrô, inspirado no clássico Windows 98! Por quê? Porque 1998 é o ano em que nasci, e eu queria algo que se destacasse da multidão. Misturar um site moderno com uma vibe de um sistema operacional clássico parecia a maneira perfeita de criar uma experiência digital única. É uma homenagem divertida ao passado, envolta em um design nostálgico e ao mesmo tempo inovador.',
			'en-US':
	...
	aboutMe: {
		...
		description: {
			'pt-BR': [
				'Sou um engenheiro de software apaixonado por criar soluções tecnológicas inovadoras e de alta qualidade, com ampla experiência em desenvolvimento fullstack e frontend. Ao longo da minha carreira, tive a oportunidade de trabalhar em empresas renomadas como Gympass, Lend, Nubank e PagSeguro PagBank, onde fui responsável pelo desenvolvimento, manutenção e liderança de projetos complexos, com foco em sistemas de gestão de conteúdo, plataformas de autenticação e aplicativos web robustos.',
				'Minhas habilidades incluem criar bibliotecas de componentes usando metodologias como Atomic Design, desenvolver testes unitários e end-to-end (E2E) com Cypress, e utilizar tecnologias de ponta como React, Next.js, Node.js e Clojure. Sou proficiente em gerenciar o ciclo completo de implantação com ferramentas como GitHub Actions, Docker e AWS, além de trabalhar com metodologias ágeis, como Scrum e Kanban, para garantir entregas eficientes e colaborativas.',
				'Minha experiência como Feature Lead me proporcionou uma visão ampla sobre arquitetura de software e gestão ágil, sempre focando em entregar produtos que atendam às necessidades dos usuários, com excelência em design e funcionalidade. Além disso, sou entusiasta em aprimorar a experiência do usuário (UX) e aplicar as melhores práticas de desenvolvimento web para criar interfaces responsivas e intuitivas.',
				'Estou sempre em busca de novos desafios que me permitam aplicar minha experiência, aprender novas tecnologias e contribuir para o sucesso de projetos inovadores.',
			],
			'en-US': [
				'I am a software engineer passionate about creating innovative and high-quality technological solutions, with extensive experience in fullstack and frontend development. Throughout my career, I have had the opportunity to work at renowned companies such as Gympass, Lend, Nubank, and PagSeguro PagBank, where I was responsible for the development, maintenance, and leadership of complex projects, focusing on content management systems, authentication platforms, and robust web applications.',
				'My skills include creating component libraries using methodologies such as Atomic Design, developing unit and end-to-end (E2E) tests with Cypress, and utilizing cutting-edge technologies like React, Next.js, Node.js, and Clojure. I am proficient in managing the full deployment cycle using tools like GitHub Actions, Docker, and AWS, and I work with agile methodologies, including Scrum and Kanban, to ensure efficient and collaborative deliveries.',
				"My experience as a Feature Lead has given me a broad perspective on software architecture and agile management, always focusing on delivering products that meet users' needs with excellence in design and functionality. Additionally, I am an enthusiast in enhancing user experience (UX) and applying best web development practices to create responsive and intuitive interfaces.",
				'I am always seeking new challenges that allow me to apply my experience, learn new technologies, and contribute to the success of innovative projects.',
			],
		},
	},
	linkedinBlockquote: {
		text: {
			'pt-BR': 'Me conheça melhor no ',
			'en-US': 'Get to know me better on ',
		},
	},
	githubBlockquote: {
		text: {
			'pt-BR': 'Saiba mais sobre o meu perfil no ',
